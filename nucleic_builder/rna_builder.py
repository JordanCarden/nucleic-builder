        ...
        if not inserted and stripped.startswith("; MARTINI"):
            if generated_structure is None:
                ...
                if generated_structure.strand_mode == "single":
                    ...
                    # Preserve the validated duplex provenance byte-for-byte.
                    provenance_lines = [
                        "; Generated by nucleic_builder Phase 2A",
...
def build_rna(
    ...
    *,
    ...
    return BuildResult(
        ...
        strand_mode=(
            _generated_structure.strand_mode
            if _generated_structure is not None
            else None
        ),
    )
